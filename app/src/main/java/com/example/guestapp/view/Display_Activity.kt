...
import kotlinx.android.synthetic.main.activity_display_.*
...
class Display_Activity : AppCompatActivity(), GuestAdapter.GuestAdapterDelegate {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val reserve: Guest = intent?.getParcelableExtra("name_key") as Guest
        ...
        checkback_in_button.setOnClickListener { _ ->
